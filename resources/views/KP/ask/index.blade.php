...
@section('content_header')
  <h1>Kartu Pengawasan <small>Angkutan Sewa Khusus</small></h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Kartu Pengawasan (Angkutan Sewa Khusus)</h3>
          <div class="box-tools">
            <a href="{{route('kp.ask.create')}}" type="button" id="btntambah" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Buat Kartu Pengawasan</a>
          </div>
        </div>
        <div class="box-body">
