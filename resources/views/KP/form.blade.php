...
@section('content_header')
  <h1>Kartu Pengawasan {{$jangkutan}}</h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form id="form-utama" role="form" data-toggle="validator" action="{{route('kp.'.$angkutan.'.store')}}" method="post">
          {{ csrf_field() }} {{ method_field('POST') }}
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-3">
                <label for="sak" class="control-label">Status Awal Kendaraan</label>
                <select class="form-control" name="sak" id="sak" required style="width: 100%;"></select>
              </div>

              @if ($angkutan == 'taksi')
                <div class="form-group col-md-2">
                  <label for="nokp" class="control-label">Nomor KP</label>
                  <input type="text" class="form-control" name="nokp" placeholder="No Kartu Pengawasan" required>
                </div>
              @endif

              <div class="form-group col-md-{{$angkutan == 'taksi' ? '4' : '6'}}">
                <label for="nosk" class="control-label">Nomor Surat Keputusan</label>
                <input type="text" class="form-control" name="nosk" id="nosk" placeholder="Nomor Surat Keputusan" required>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tglsk" id="tglsk" required>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-7">
                ...
                <div class="input-group">
                  <select class="form-control" name="perusahaan" id="perusahaan" required style="width: 100%;"></select>
              ...
              <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" id="wilayah" readonly="true">
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="tglawal" value="{{date('Y-m-d')}}" readonly="true">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="tglakhir" value="{{date('Y-m-d', strtotime('+5 year'))}}" readonly="true">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nokendaraan" id="nokendaraan" placeholder="Nomor Kendaraan" required>
                </div>
                <div class="form-group">
                  <label for="tahunkendaraan" class="control-label">Tahun Kendaraan</label>
                  <input type="text" class="form-control" name="tahunkendaraan" id="tahunkendaraan" placeholder="Tahun Kendaraan" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="pemilik" id="pemilik" placeholder="Pemilik Kendaraan" required>
                </div>
                <div class="form-group">
                  <label for="alamatkendaraan" class="control-label">Alamat</label>
                  <input type="text" class="form-control" name="alamatkendaraan" id="alamatkendaraan" placeholder="Alamat" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="ditetaptgl" id="ditetaptgl" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="nouji" class="control-label">Nomor Uji</label>
                  <input type="text" class="form-control" name="nouji" id="nouji" placeholder="Nomor Kendaraan" required>
                </div>
                <div class="form-group">
                  <label for="isisilinder" class="control-label">Isi Silinder</label>
                  <input type="text" class="form-control" name="isisilinder" id="isisilinder" placeholder="Isi Silinder" required>
                </div>
                <div class="form-group">
                  <label for="jbi" class="control-label">JBI</label>
                  <div class="input-group">
                    <input type="text" class="form-control" name="jbi" id="jbi" placeholder="Jumlah Berat yang Diizinkan" required>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="dayaorang" id="dayaorang" placeholder="Jumlah Daya Orang" required>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="dayabarang" id="dayabarang" placeholder="Jumlah Daya Barang" required>
                    <span class="input-group-addon">Kg</span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="nolambung" class="control-label">Nomor Lambung</label>
                  <input data-remote="" type="text" class="form-control" name="nolambung" id="nolambung" placeholder="Nomor Lambung" value="" required>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    function savePrint() {
      ...
      $.ajax({
        url: "{{ route('kp.'. $angkutan .'.api.store') }}",
        type: 'POST',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
