...
<html>
<head>
  <title>{{ 'KP ASK Pendapatan - '.date_format(date_create($tglawal),"d-m-Y").' / '.date_format(date_create($tglakhir),"d-m-Y") }}</title>
  <style>
    table {
...
<body>
  <h1>Laporan Pendapatan Angkutan Sewa Khusus</h1>
