...
@section('content_header')
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Angkutan Taksi</li>
  </ol>
@stop
...
<div class="row">
  <div class="col-md-6">
    <div class="box">
      ...
      <h3 class="box-title">Laporan Semua Angkutan Taksi</h3>
      </div>
      <form id="form-semua" role="form" data-toggle="validator" action="{{ route('lap.taksi.semua') }}" method="post" target="_blank">
        <div class="box-body">
  ...
  <div class="col-md-6">
    <div class="box">
      ...
      <form id="form-pendapatan" role="form" data-toggle="validator" action="{{ route('lap.taksi.pendapatan') }}" method="post" target="_blank">
        <div class="box-body">
          {{ csrf_field() }} {{ method_field('POST') }}
          <div class="form-group">
            <div class="input-group">
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Laporan Angkutan Taksi Per Perusahaan / Koperasi</h3>
      </div>
      <form id="form-per" role="form" data-toggle="validator" action="{{ route('lap.taksi.per') }}" method="post" target="_blank">
        <div class="box-body">
          {{ csrf_field() }} {{ method_field('POST') }}
          <div class="row">
...
<div class="row">
  <div class="col-md-6">
    <div class="box">
      ...
      <form id="form-rekap" role="form" data-toggle="validator" action="{{ route('lap.taksi.rekap') }}" method="post" target="_blank">
        <div class="box-body">
          {{ csrf_field() }} {{ method_field('POST') }}
          <div class="form-group">
            <div class="input-group">
