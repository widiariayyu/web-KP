...
@section('content_header')
  <h1>Ubah Peremajaan Kendaraan Sewa Taksi</h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form id="form-utama" role="form" data-toggle="validator" action="{{route('peremajaan.taksi.update', ['id' => $data->id ])}}" method="post">
          {{ csrf_field() }} {{ method_field('PUT') }}
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-4">
                <label class="control-label">No. Peremajaan</label>
                <input type="text" class="form-control" name="no_peremajaan" value="{{ $data->no_peremajaan }}" placeholder="Nomor Surat Peremajaan" required>
              </div>

              <div class="form-group col-md-4">
                <label class="control-label">No. Surat Permohonan</label>
                <input type="text" class="form-control" name="no_surat_permohonan" value="{{ $data->no_surat_permohonan }}" placeholder="Nomor Surat Permohonan" required>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <div class="input-group">
                  ...
                  <input readonly type="text" class="form-control tglpilih" id="tglsuratpermohonan" value="{{ date_format(date_create($data->tgl_surat_permohonan),"d-m-Y") }}" required>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  <input id="no_kp" readonly type="text" class="form-control" value="{{ $data->no_kp }}" placeholder="Nomor Kartu Pengawasan" required>
                  <span class="input-group-btn">
                    <button data-toggle="modal" data-target="#modal-kp" type="button" class="btn btn-info btn-flat"><i class="fa fa-search"></i></button>
                  </span>
                </div>
                <input type="hidden" value="{{ $data->nolambung }}" name="nolambung">
                <input type="hidden" value="{{ $data->kode_kp }}" name="kode_kp">
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <input id="no_kendaraan" readonly type="text" class="form-control" value="{{ $data->no_kendaraan_lama }}" placeholder="Nomor Kendaraan">
              </div>

              <div class="form-group col-md-4">
                <label class="control-label">No. Uji Kendaraan</label>
                <input id="nomor_uji" readonly type="text" class="form-control" value="{{ $data->no_uji_kendaraan_lama }}" placeholder="Nomor Uji Kendaraan">
              </div>

              <div class="form-group col-md-4">
                <label class="control-label">Tahun Kendaraan</label>
                <input id="tahun_kendaraan" readonly type="text" class="form-control" value="{{ $data->tahun_kendaraan_lama }}" placeholder="Tahun Kendaraan">
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <input id="merk" readonly type="text" class="form-control" value="{{ $data->merklama->merk }}" placeholder="Merk Kendaraan">
              </div>

              <div class="form-group col-md-8">
                <label class="control-label">Alamat Perusahaan</label>
                <input id="alamat" readonly type="text" class="form-control" value="{{ $data->perusahaan->alamat }}" placeholder="Alamat Perusahaan">
              </div>
            </div>
          </div>
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control tglpilih" placeholder="Tanggal Faktur Kendaraan" id="tglfaktur" value="{{ date_format(date_create($data->tgl_faktur),"d-m-Y") }}">
                </div>
              </div>
              <input type="hidden" name="tgl_faktur" value="{{ $data->tgl_faktur }}">
            </div>

            <div class="row">
              <div class="form-group col-md-4">
                <label class="control-label">Nomor Kendaraan</label>
                <input type="text" class="form-control" name="no_kendaraan" value="{{ $data->no_kendaraan }}" placeholder="Nomor Kendaraan" required>
              </div>

              <div class="form-group col-md-4">
                <label class="control-label">Tahun Kendaraan</label>
                <input type="text" class="form-control" name="tahun_kendaraan" value="{{ $data->tahun_kendaraan }}" placeholder="Tahun Kendaraan" required>
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="no_mesin" value="{{ $data->no_mesin }}" placeholder="Nomor Mesin Kendaraan" required>
              </div>

              <div class="form-group col-md-6">
                <label class="control-label">Nomor Rangka</label>
                <input type="text" class="form-control" name="no_rangka" value="{{ $data->no_rangka }}" placeholder="Nomor Rangka Kendaraan" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" name="pemilik" value="{{ $data->pemilik }}" placeholder="Pemilik Kendaraan" required>
              </div>

              <div class="form-group col-md-7">
                <label class="control-label">Alamat</label>
                <input type="text" class="form-control" name="alamat" value="{{ $data->alamat }}" placeholder="Alamat Pemilik Kendaraan" required>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    function savePrint() {
      ...
      $.ajax({
        url: "{{ route('peremajaan.taksi.api.update', ['id' => $data->id ]) }}",
        type: 'PUT',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
        ...
        success: function (data) {
          ...
          var urlprint = "{{ URL('peremajaan/taksi/cetak') }}/";
    ...
    $("select[name=mperusahaan_id]").select2({
      ...
      allowClear: false,
      ajax: {
          url: '{{ route("taksi.perusahaan.select") }}',
          dataType: 'json',
    ...
    select2isi('select[name=mperusahaan_id]', "{{ $data->perusahaan->id }}", "{{ $data->perusahaan->nama_perusahaan }}");
    select2isi('select[name=mmerk_id]', "{{ $data->merk->id }}", "{{ $data->merk->merk }}");

    var table = $('#table').DataTable({
      processing: true,
      serverSide: true,
      responsive: true,
      ajax: "{{ route('peremajaan.taksi.getkp') }}",
      columns: [
    ...
    $('#btnperusahaantambah').click(function(){
      ...
      $.ajax({
        url: "{{ route('api.taksi.perusahaan.store') }}",
        type: 'POST',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
