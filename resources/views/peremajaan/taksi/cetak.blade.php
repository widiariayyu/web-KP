...
<body>
  <p align="right" style="margin-right: 90px;">
  ...
  <table style="width:100%; padding-left: 10px;">
    ...
    <tr>
      <td>Perihal</td>
      <td> : </td>
      <td>Perubahaan Sifat Sekaligus</td>
      <td></td>
      <td></td>
      <td><b>Di -</b></td>
    </tr>
    <tr>
      <td></td>
      <td></td>
      <td>Peremajaan Menjadi TNKB Warna Dasar Kuning Angkutan Taksi</td>
      <td></td>
      <td></td>
  ...
  <div style="padding-left: 100px;">
    <table style="width:100%; padding-left: 15px;">
      <tr>
        ...
        <td class="jstfy">Menunjuk Surat Permohonan dari <b style="text-transform: uppercase;">{{$data->perusahaan}}</b> Nomor : {{$data->no_surat_permohonan}} tanggal {{Fungsi::bulanID($data->tgl_surat_permohonan)}} perihal Perubahan Sifat Sekaligus Peremajaan Menjadi TNKB Warna Dasar Kuning Angkutan Taksi.</td>
      </tr>
      <tr>
        <td>2.</td>
        <td class="jstfy">Sehubungan dengan hal tersebut diatas, kami pada prinsipnya tidak keberatan dengan permohonan saudara tentang Peremajaan Kendaraan Angkutan Taksi.</td>
      </tr>
      <tr>
        <td></td>
        <td>
          <table style="margin-top:10px; margin-bottom:10px;">
            ...
            <tr>
              <td>Nomor Lambung</td>
              <td> : </td>
              <td colspan="2" style="text-transform: uppercase;">{{$data->nolambung}}</td>
            </tr>
            <tr>
              <td>Nama Pemilik</td>
              <td> : </td>
      ...
      <tr>
        <td>4.</td>
        <td>Pengambilan Kartu Pengawasan agar Menunjukan Copy STNK kendaraan yang diganti sebagai kendaraan <b>Tidak Umum / Pribadi.</b></td>
      </tr>
    </table>
  </div>
