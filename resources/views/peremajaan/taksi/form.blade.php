...
@section('content_header')
  <h1>Peremajaan Kendaraan Sewa Taksi</h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form id="form-utama" role="form" data-toggle="validator" action="{{route('peremajaan.taksi.store')}}" method="post">
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    function savePrint() {
      ...
      $.ajax({
        url: "{{ route('peremajaan.taksi.api.store') }}",
        type: 'POST',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
