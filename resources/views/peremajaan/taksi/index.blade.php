    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools">
            <a href="{{route('peremajaan.taksi.create')}}" type="button" id="btntambah" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Peremajaan</a>
          </div>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
    ...
    var id;
	  var table = $('#table').DataTable({
	      processing: true,
	      serverSide: true,
	      ajax: '{{ route('peremajaan.taksi.get') }}',
	      columns: [
