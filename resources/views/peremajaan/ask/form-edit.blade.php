...
@section('content_header')
  <h1>Ubah Peremajaan Kendaraan Sewa Khusus</h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form id="form-utama" role="form" data-toggle="validator" action="{{route('peremajaan.ask.update', ['id' => $data->id ])}}" method="post">
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    function savePrint() {
      ...
      $.ajax({
        url: "{{ route('peremajaan.ask.api.update', ['id' => $data->id ]) }}",
        type: 'PUT',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
