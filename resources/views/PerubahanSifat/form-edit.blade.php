...
@section('content_header')
  <h1>Ubah Surat Rekomendasi Perubahan Sifat</h1>
  <ol class="breadcrumb">
    <li><a href="{{route('perubahansifat')}}"><i class="fa fa-dashboard"></i> Perubahan Sifat</li></a>
    <li class="active">Ubah Surat Rekomendasi</li>
  </ol>
@stop
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form id="form-utama" role="form" data-toggle="validator" action="{{ route('perubahansifat.update', ['id' => $data->id]) }}" method="post">
          {{ csrf_field() }} {{ method_field('PUT') }}
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-4">
                <label class="control-label">Nomor Surat Rekomendasi Perubahan Sifat</label>
                <input type="text" class="form-control" name="no_surat_rekomendasi" placeholder="Nomor Surat Rekomendasi Perubahan Sifat" value="{{ $data->no_surat_rekomendasi }}" readonly required>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="katusaha" value="{{ $data->perusahaan->katperusahaan->kategori_perusahaan }}" readonly="true">
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="no_surat_permohonan" placeholder="Nomor Surat Permohonan" value="{{ $data->no_surat_permohonan }}" required>
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control tglpilih" id="tglsuratpermohonan" value="{{ date_format(date_create($data->tgl_surat_permohonan),"d-m-Y") }}" required>
                </div>
              </div>
              <input type="hidden" value="{{ $data->tgl_surat_permohonan }}" name="tgl_surat_permohonan">
            </div>

            <div class="row">
              <div class="form-group col-md-4">
                <label class="control-label">No. Surat Penyelenggaraan</label>
                <input type="text" class="form-control" name="nosuratpenyelenggaraan" placeholder="Nomor Surat Penyelenggaraan" value="{{ $data->nosuratpenyelenggaraan }}" required>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control tglpilih" value="{{ date_format(date_create($data->tglsuratpenyelenggaraan),"d-m-Y") }}" id="tglsuratpenyelenggaraan" required>
                </div>
              </div>
              <input type="hidden" value="{{ $data->tglsuratpenyelenggaraan }}" name="tglsuratpenyelenggaraan">

              <div class="form-group col-md-5">
                <label class="control-label">Pasal Peraturan Mentri</label>
                <div class="input-group">
                  <input type="text" class="form-control" id="pasalpermen" value="{{ $data->suratpasal->pasal_permen }}" readonly="true">
                  <span class="input-group-addon">Nomor</span>
                  <input type="text" class="form-control" id="nopermen" value="{{ $data->suratpasal->no_permen }}" readonly="true">
                </div>
              </div>
              <input type="hidden" value="{{ $data->msettingsuratpasal_id }}" name="msettingsuratpasal_id">
            </div>
          </div>
          ...
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control tglpilih" value="{{ date_format(date_create($data->tahun_kendaraan),"d-m-Y") }}" id="tahunkendaraan" placeholder="Tahun Kendaraan">
                </div>
              </div>
              <input type="hidden" value="{{ $data->tahun_kendaraan }}" name="tahun_kendaraan">

              <div class="form-group col-md-4">
                <label class="control-label">Nomor Faktur</label>
                <input type="text" class="form-control" name="no_faktur" placeholder="No Faktur Kendaraan" value="{{ $data->no_faktur }}" required>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control tglpilih" value="{{ date_format(date_create($data->tgl_faktur),"d-m-Y") }}" placeholder="Tanggal Faktur Kendaraan" id="tglfaktur">
                </div>
              </div>
              <input type="hidden" value="{{ $data->tgl_faktur }}" name="tgl_faktur">
            </div>

            <div class="row">
              <div class="form-group col-md-6">
                <label class="control-label">Pemilik Kendaraan</label>
                <input type="text" class="form-control" name="pemilik" placeholder="Pemilik Kendaraan" value="{{ $data->pemilik }}" required>
              </div>

              <div class="form-group col-md-6">
                <label class="control-label">Nomor Kendaraan</label>
                <input type="text" class="form-control" name="no_kendaraan" placeholder="Nomor Kendaraan" value="{{ $data->no_kendaraan }}" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="no_rangka" placeholder="Nomor Rangka Kendaraan" value="{{ $data->no_rangka }}" required>
              </div>

              <div class="form-group col-md-6">
                <label class="control-label">Nomor Mesin</label>
                <input type="text" class="form-control" name="no_mesin" placeholder="Nomor Mesin Kendaraan" value="{{ $data->no_mesin }}" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-9">
                ...
                <input type="text" class="form-control" name="alamat" placeholder="Alamat Pemilik Kendaraan" value="{{ $data->alamat }}" required>
              </div>
...
<script type="text/javascript">
  ...
  $( document ).ready(function() {
    ...
    function savePrint() {
      ...
      $.ajax({
        url: "{{ url('perubahansifat/api') }}/"+ "{{ $data->id }}",
        type: 'PUT',
        data: {
          _token: CSRF_TOKEN,
          form:jadi
    ...
    var loadperusahaan = "{{ $data->perusahaan->id }}";

    if ($('select[name=mperusahaan_id]').find("option[value='" + loadperusahaan + "']").length) {
      $('select[name=mperusahaan_id]').val(loadperusahaan).trigger('change');
    }else{
      var newOption = new Option("{{ $data->perusahaan->nama_perusahaan }}", loadperusahaan, true, true);
      $('select[name=mperusahaan_id]').append(newOption).trigger('change');
    }
    ...
    var loadjeniskendaraan = "{{ $data->jeniskendaraan->id }}";

    if ($('select[name=mjeniskendaraan_id]').find("option[value='" + loadjeniskendaraan + "']").length) {
      $('select[name=mjeniskendaraan_id]').val(loadjeniskendaraan).trigger('change');
    }else{
      var newOption = new Option("{{ $data->jeniskendaraan->jenis }}", loadjeniskendaraan, true, true);
      $('select[name=mjeniskendaraan_id]').append(newOption).trigger('change');
    }
    ...
    var loadmerk = "{{ $data->merk->id }}";

    if ($('select[name=mmerk_id]').find("option[value='" + loadmerk + "']").length) {
      $('select[name=mmerk_id]').val(loadmerk).trigger('change');
    }else{
      var newOption = new Option("{{ $data->merk->merk }}", loadmerk, true, true);
      $('select[name=mmerk_id]').append(newOption).trigger('change');
    }
...
//form Master
    ...
    var loadwilayah = "{{ $data->wilayahPemilik->id }}";

    if ($('select[name=wilayah_id]').find("option[value='" + loadwilayah + "']").length) {
      $('select[name=wilayah_id]').val(loadwilayah).trigger('change');
    }else{
      var newOption = new Option("{{ $data->wilayahPemilik->wilayah }}", loadwilayah, true, true);
      $('select[name=wilayah_id]').append(newOption).trigger('change');
    }
